...
거실등1.register_status(message_flag = 'c1', attr_name = 'power', topic_class ='state_topic', regex = r'0500(0[01])', process_func = lambda v: 'ON' if v == '01' else 'OFF')
거실등2.register_status(message_flag = 'c1', attr_name = 'power', topic_class ='state_topic', regex = r'0500(0[01])', process_func = lambda v: 'ON' if v == '01' else 'OFF')
복도등.register_status( message_flag = 'c1', attr_name = 'power', topic_class ='state_topic', regex = r'0500(0[01])', process_func = lambda v: 'ON' if v == '01' else 'OFF')
